...
% acima de  30 rad/s com atenuação mínima de 20 dB.

clc
clear
close all

%%% BLOCO I - Projeto do Filtro Analógico - Mesmo Passo-a-Passo do Exemplo
%%% 8.8
...
%%% BLOCO II - DISCRETIZACAO

%Cria a funcao de transferência
sysc = tf(B,A);
...
%Diagrama de Polos e Zeros e Resposta em Frequência
